...
let MainFormComponent = class MainFormComponent {
    ...
    onSubmit() {
        const { firstName, lastName, startDate, endDate, client, project, completed, inProgress, starting, issues } = this.statusForm.controls;
